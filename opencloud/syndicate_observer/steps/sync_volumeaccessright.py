    ...
    def sync_record(self, vac):
        ...
        try:
            ...
            try:
                ...
                traceback.print_exc()
                log.error("Failed to ensure user '%s' exists" % vac.owner_id.email )
                return False
            ...
            try:
                ...
                traceback.print_exc()
                log.error("Faoed to ensure user %s can access Volume %s with rights %s" % (vac.owner_id.email, vac.volume.name, syndicate_caps))
                return False
