...
urlpatterns = patterns('django_ug.views',
                       ...
                       url(r'^changewrite/(?P<g_id>[\w\.-]+)/?$', 'changewrite'),       
                       url(r'^changelocation/(?P<g_id>[\w\.-]+)/?$', 'changelocation'),
                       url(r'^changevolume/(?P<g_id>[\w\.-]+)/?$', 'changevolume'), 
                       ...
                       url(r'^create/(?P<volume_name>[\w\.-]+)/(?P<g_id>[\w\.-]+)/(?P<g_password>[\w\.-]+)/(?P<host>[\w\.-]+)/(?P<port>[\d]+)/(?P<read_write>[\w]+)/?', 'urlcreate'),
                       url(r'^delete/(?P<g_id>[\w\.-]+)/(?P<g_password>[\w\.-]+)/?', 'urldelete'),
)
