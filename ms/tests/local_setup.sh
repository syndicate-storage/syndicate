...
cp user_test_key.pem $SYNCONF/user_keys/signing/$USER_ID.rsa
...
$SYNTOOL -t -u testuser@gmail.com create_volume testuser@gmail.com testvolume "Test Volume" 61440 MAKE_SIGNING_KEY metadata_private_key=MAKE_METADATA_KEY private=True default_gateway_caps=$DEFAULT_GATEWAY_CAPS
