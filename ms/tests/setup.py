   ...
   if do_init:
      ...
      for i, user_email in enumerate(users):
         ...
         try:
            ...
            volume_key = storage.create_volume( user, name=test_volume_name, description="%s's test volume" % user_email, blocksize=64*1024, volume_secret="abcdef", volume_secret_salt="abcdef", active=True, owner_id=i+1 )
